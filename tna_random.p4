...
control SwitchIngress(
    ...
    RegisterAction<reg_value, bit<10>, bool>(stage_one) stage_one_read_val = {
    ...
    // Compute fingerprint and insert into reg array entry at idx
    // RegisterAction<reg_value, bit<10>, bit<32>>(stage_two) stage_two_insert_flow = {
    //     void apply(inout reg_value val, out bit<32> rv) {  
    //         val.val = ig_md.fingerprint;
    //         rv = 1;
    //     }
    ...
    apply {
        ...
        ig_tm_md.icos_for_copy_to_cpu = 1;
